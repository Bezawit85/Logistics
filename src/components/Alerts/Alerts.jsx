...
const Alerts = () => {
  ...
  const apiOffroadAlert = `${mainAPI}${endpoints.Alerts}/OFFROAD`;
  const apiAccidentAlert = `${mainAPI}${endpoints.Alerts}/ACCIDENT`;
  const apiDriverAlert = `${mainAPI}${endpoints.Alerts}/DRIVER`;
