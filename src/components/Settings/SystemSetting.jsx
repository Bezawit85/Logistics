...
const SystemSetting = () => {
  ...
  const apinotification = `${mainAPI}${endpoints.List.Notification}`;
  const apiCompanySector = `${mainAPI}${endpoints.List.CompanySector}`;
  const apiCompanyType = `${mainAPI}${endpoints.List.CompanyType}`;
  const apiService = `${mainAPI}${endpoints.List.Services}`;
  const apiRoles = `${mainAPI}${endpoints.List.Roles}`;
  const apiDriverStatus = `${mainAPI}${endpoints.List.DriverStatus}`;
  const apiAlertType = `${mainAPI}${endpoints.List.AlertType}`;
  const apiTripType = `${mainAPI}${endpoints.List.TripType}`;
  const apiBusinessSector = `${mainAPI}${endpoints.List.BusinessSector}`;
  const apiBusinessType = `${mainAPI}${endpoints.List.BusinessType}`;
  const apiCargoType = `${mainAPI}${endpoints.List.CargoType}`;
  const apiDriverState = `${mainAPI}${endpoints.List.DriverState}`;
  const apiLogoAvatar = `${mainAPI}${endpoints.List.LogoandAvatar}`;
  const apiVehicleCatagory = `${mainAPI}${endpoints.List.VehicleCatagory}`;
  const apiVehicleCondition = `${mainAPI}${endpoints.List.VehicleCondition}VehicleCondition`;
