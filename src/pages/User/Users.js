...
const Users = () => {
  ...
  const apiVehicleOwners = `${mainAPI}${endpoints.List.VehicleOwners}`;
  const apiCargoOwners = `${mainAPI}${endpoints.List.CargoOwners}`; 
  ...
  const apiaddVehicle = `${mainAPI}${endpoints.Create.AddVehicle}`;
  //Company Api
  const apiCompany = `${mainAPI}${endpoints.List.VehicleOwners}/Role/owner`;
  //Individual API
  const apiIndivisual = `${mainAPI}${endpoints.List.VehicleOwners}/Role/individual`;
