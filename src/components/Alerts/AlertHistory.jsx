...
const AlertsHistory = () => {
  ...
  const apiOffroadAlert = `${mainAPI}${endpoints.AlertHistory}/DRIVER`;
  const apiAccidentAlert = `${mainAPI}${endpoints.AlertHistory}/ACCIDENT`;
  const apiDriverAlert = `${mainAPI}${endpoints.AlertHistory}/DRIVER`;
